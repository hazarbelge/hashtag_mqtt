...
class DeviceInfoUtil {
  ...
  static Future<Map<String, dynamic>> getDeviceData() async {
    ...
    try {
      if (kIsWeb) {
        data = DeviceInfoUtil.readWebBrowserInfo(await deviceInfoPlugin.webBrowserInfo);
      } else {
        if (Platform.isAndroid) {
          data = DeviceInfoUtil.readAndroidBuildData(await deviceInfoPlugin.androidInfo);
        } else if (Platform.isIOS) {
          data = DeviceInfoUtil.readIosDeviceInfo(await deviceInfoPlugin.iosInfo);
        } else if (Platform.isLinux) {
          data = DeviceInfoUtil.readLinuxDeviceInfo(await deviceInfoPlugin.linuxInfo);
        } else if (Platform.isMacOS) {
          data = DeviceInfoUtil.readMacOsDeviceInfo(await deviceInfoPlugin.macOsInfo);
        } else if (Platform.isWindows) {
          data = DeviceInfoUtil.readWindowsDeviceInfo(await deviceInfoPlugin.windowsInfo);
        }
      }

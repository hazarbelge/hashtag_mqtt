...
class SnackbarToastUtil {
  ...
  static Future<void> showErrorSnackbar({
    ...
    await Flushbar<dynamic>(
      flushbarPosition: FlushbarPosition.TOP,
      title: title?.trim().isNotEmpty == true ? title : "something.went.wrong".tr,
      message: message?.trim().isNotEmpty == true ? message : "try.later".tr,
      duration: _snackbarDuration,
    ...
    /*currentSnackbar = Get.snackbar(
      title ?? "edonusum.component.something.went.wrong".tr,
      message ?? "edonusum.component.try.later".tr,
      duration: duration ?? _snackbarDuration,
      backgroundColor: Colors.white38,
      margin: Paddings.onlyTop20Left10Right10,
      backgroundGradient: LinearGradient(
